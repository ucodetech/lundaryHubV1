...
return [
    ...
    */
    ...
    'android' => [
        ...
        'android_sdk_path' => env('NATIVEPHP_ANDROID_SDK_LOCATION', 'C:/Users/ejekw/AppData/Local/Android/Sdk'),
        'emulator_path' => env('ANDROID_EMULATOR'),
        '7zip-location' => env('NATIVEPHP_7ZIP_LOCATION', base_path('7z.exe')),
