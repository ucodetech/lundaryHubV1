...
<template>
  <AppLayout>
    <div class="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-slate-100">Create Digital Storefront</h1>
        <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">Register your dry cleaning business to receive online pickup bookings</p>
      </div>

      <form @submit.prevent="submit" class="bg-gray-100 dark:bg-slate-800/60 border border-gray-200 dark:border-slate-700/60 rounded-2xl p-6 space-y-5 shadow-xl">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p class="text-[11px] text-gray-500 dark:text-slate-400 mt-0.5">Corporate Affairs Commission (RC/BN) registered shop</p>
            </button>
            ...
            >
              ...
              <p class="text-[11px] text-gray-500 dark:text-slate-400 mt-0.5">Sole proprietorship / Unregistered local shop</p>
            </button>
          </div>
        </div>

        <div>
          <label class="block text-xs font-semibold text-gray-700 dark:text-slate-300 uppercase mb-1">Shop Name *</label>
          <input
            v-model="form.name"
            type="text"
            required
        ...
        <div>
          <label class="block text-xs font-semibold text-gray-700 dark:text-slate-300 uppercase mb-1">Description</label>
          <textarea
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label class="block text-xs font-semibold text-gray-700 dark:text-slate-300 uppercase mb-1">Pickup Radius (KM)</label>
            <input
          ...
          <div>
            <label class="block text-xs font-semibold text-gray-700 dark:text-slate-300 uppercase mb-1">Default Delivery Fee (₦)</label>
            <input
